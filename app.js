...
typewriter
  .pauseFor(1800)
  .changeDelay(20)
  .typeString("Moi c'est Lionel")
  .pauseFor(300)
  .typeString("<strong>, Développeur Front-End</strong> !")
  .pauseFor(1000)
  .deleteChars(12)
  .typeString('<span style="color: #df2048;"> CSS</span> !')
  .pauseFor(1000)
  .deleteChars(6)
  ...
  .pauseFor(1000)
  .deleteChars(2)
  .typeString('<span style="color: midnightblue;"> - Native</span> !')
  .start();
...
// const titrePassions = document.querySelector(".titre-passions");
// const itemPassions = document.querySelectorAll(".vague1");

// const tlPassions = new TimelineMax();

// tlPassions
//   .from(titrePassions, { y: -50, opacity: 0, duration: 0.5 })
//   .staggerFrom(itemPassions, 1, { opacity: 0 }, 0.2, "-=0.5");

// const scenePassions = new ScrollMagic.Scene({
//   triggerElement: passionContainer,
//   triggerHook: 0.5,
//   reverse: false,
// })
//   .setTween(tlPassions)
...
// // Vague2
// const passionsContainer2 = document.querySelector(".passions");
// const titrePassions2 = document.querySelector(".titre-passions");
// const itemPassions2 = document.querySelectorAll(".vague2");

// const tlPassions2 = new TimelineMax();

// tlPassions2
//   .from(titrePassions2, { y: -50, opacity: 0, duration: 0.5 })
//   .staggerFrom(itemPassions2, 1, { opacity: 0 }, 0.2, "-=0.5");

// const scenePassions2 = new ScrollMagic.Scene({
//   triggerElement: passionContainer2,
//   triggerHook: 0.5,
//   reverse: false,
// })
//   .setTween(tlPassions2)
//   .addIndicators()
//   .addTo(controller);
